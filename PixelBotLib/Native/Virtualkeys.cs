namespace PixelBotLib.Native
{
    ...
    * Virtual Keys, Standard Set */
        ...
        public static uint VK_MBUTTON = 0x04;    /* NOT contiguous with L & RBUTTON */

        //#if(_WIN32_WINNT >= 0x0500)
        public static uint VK_XBUTTON1 = 0x05;    /* NOT contiguous with L & RBUTTON */
        public static uint VK_XBUTTON2 = 0x06;    /* NOT contiguous with L & RBUTTON */
    ...
    * 0x0A - 0x0B : reserved */
        ...
        public static uint VK_HANGEUL = 0x15;  /* old name - should be here for compatibility */
    ...
    * NEC PC-9800 kbd definitions */
        public static uint VK_OEM_NEC_EQUAL = 0x92;   // '=' key on numpad

        /*
    * Fujitsu/OASYS kbd definitions */
        public static uint VK_OEM_FJ_JISHO = 0x92;   // 'Dictionary' key
        public static uint VK_OEM_FJ_MASSHOU = 0x93;   // 'Unregister word' key
        public static uint VK_OEM_FJ_TOUROKU = 0x94;   // 'Register word' key
        public static uint VK_OEM_FJ_LOYA = 0x95;   // 'Left OYAYUBI' key
        public static uint VK_OEM_FJ_ROYA = 0x96;   // 'Right OYAYUBI' key
    ...
    * VK_L* & VK_R* - left and right Alt, Ctrl and Shift virtual keys. * Used only as parameters to GetAsyncKeyState() and GetKeyState(). * No other API or message will distinguish left and right keys in this way. */
        ...
        /*
    * 0xB8 - 0xB9 : reserved */
        public static uint VK_OEM_1 = 0xBA;   // ';:' for US
        public static uint VK_OEM_PLUS = 0xBB;   // '+' any country
        public static uint VK_OEM_COMMA = 0xBC;   // ',' any country
        public static uint VK_OEM_MINUS = 0xBD;   // '-' any country
        public static uint VK_OEM_PERIOD = 0xBE;   // '.' any country
        public static uint VK_OEM_2 = 0xBF;   // '/?' for US
        public static uint VK_OEM_3 = 0xC0;   // '`~' for US

        /*
    * 0xC1 - 0xD7 : reserved */
        /*
    * 0xD8 - 0xDA : unassigned */
        public static uint VK_OEM_4 = 0xDB;  //  '[{' for US
        public static uint VK_OEM_5 = 0xDC;  //  '\|' for US
        public static uint VK_OEM_6 = 0xDD;  //  ']}' for US
        public static uint VK_OEM_7 = 0xDE;  //  ''"' for US
    ...
    * Various extended or enhanced keyboards */
        public static uint VK_OEM_AX = 0xE1;  //  'AX' key on Japanese AX kbd
        public static uint VK_OEM_102 = 0xE2;  //  "<>" or "\|" on RT 102-key kbd.
        public static uint VK_ICO_HELP = 0xE3;  //  Help key on ICO
        public static uint VK_ICO_00 = 0xE4;  //  00 key on ICO

        //#if(WINVER >= 0x0400)
        public static uint VK_PROCESSKEY = 0xE5;
        //#endif /* WINVER >= 0x0400 */

        public static uint VK_ICO_CLEAR = 0xE6;
        //#if(_WIN32_WINNT >= 0x0500)
    ...
    * Nokia/Ericsson definitions */
        public static uint VK_OEM_RESET = 0xE9;
        public static uint VK_OEM_JUMP = 0xEA;
        public static uint VK_OEM_PA1 = 0xEB;
        public static uint VK_OEM_PA2 = 0xEC;
        public static uint VK_OEM_PA3 = 0xED;
        public static uint VK_OEM_WSCTRL = 0xEE;
        public static uint VK_OEM_CUSEL = 0xEF;
        public static uint VK_OEM_ATTN = 0xF0;
        public static uint VK_OEM_FINISH = 0xF1;
        public static uint VK_OEM_COPY = 0xF2;
        public static uint VK_OEM_AUTO = 0xF3;
        public static uint VK_OEM_ENLW = 0xF4;
        public static uint VK_OEM_BACKTAB = 0xF5;
    ...
    * 0xFF : reserved */
        ...
        public static uint VK_0 = 0x30;
        public static uint VK_1 = 0x31;
        public static uint VK_2 = 0x32;
        public static uint VK_3 = 0x33;
        public static uint VK_4 = 0x34;
        public static uint VK_5 = 0x35;
        public static uint VK_6 = 0x36;
        public static uint VK_7 = 0x37;
        public static uint VK_8 = 0x38;
        public static uint VK_9 = 0x39;
        /* 0x40 : unassigned*/
        public static uint VK_A = 0x41;
        public static uint VK_B = 0x42;
        public static uint VK_C = 0x43;
        public static uint VK_D = 0x44;
        public static uint VK_E = 0x45;
        public static uint VK_F = 0x46;
        public static uint VK_G = 0x47;
        public static uint VK_H = 0x48;
        public static uint VK_I = 0x49;
        public static uint VK_J = 0x4A;
        public static uint VK_K = 0x4B;
        public static uint VK_L = 0x4C;
        public static uint VK_M = 0x4D;
        public static uint VK_N = 0x4E;
        public static uint VK_O = 0x4F;
        public static uint VK_P = 0x50;
        public static uint VK_Q = 0x51;
        public static uint VK_R = 0x52;
        public static uint VK_S = 0x53;
        public static uint VK_T = 0x54;
        public static uint VK_U = 0x55;
        public static uint VK_V = 0x56;
        public static uint VK_W = 0x57;
        public static uint VK_X = 0x58;
        public static uint VK_Y = 0x59;
        public static uint VK_Z = 0x5A;
    }
}
